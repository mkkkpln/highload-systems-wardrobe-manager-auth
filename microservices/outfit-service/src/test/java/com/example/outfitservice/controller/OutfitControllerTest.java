...
class OutfitControllerTest {
    ...
    void getById_shouldReturn404_whenNotFound() throws Exception {
        ...
        mockMvc.perform(get("/outfits/999"))
    ...
    void getPaged_shouldReturnHeaderAndBody() throws Exception {
        ...
        mockMvc.perform(get("/outfits/paged?page=0&size=10"))
                .andExpect(status().isOk())
    ...
    void getInfiniteScroll_shouldReturnList() throws Exception {
        ...
        mockMvc.perform(get("/outfits/scroll?offset=0&limit=10"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0].id").value(1));
    }
    ...
    void delete_shouldReturn204() throws Exception {
        ...
        mockMvc.perform(delete("/outfits/1"))
